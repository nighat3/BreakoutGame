...
#: list containing color of bricks
BRICK_COLOR= [colormodel.RED, colormodel.ORANGE, colormodel.YELLOW,\
...
STATE_COMPLETE = 5
#: state when player loses
STATE_LOSER = 6
#: state when player wins
STATE_WINNER = 7
#: Number of frames in a second Breakout is designed to run
FRAMES_PER_SEC = 60
